...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a58ca9c9-edbe-4408-a3a0-ae36ad067222
```

> `a58ca9c9-edbe-4408-a3a0-ae36ad067222` is the password of the certificate, you can change it to any password you want.
